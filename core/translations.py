...
TRANSLATIONS = {
    "en": {
        ...
        # Empty states
        "no_habits_yet": "No habits yet — add some in the Habits page",
        "no_tasks_today": "No tasks due today",
        "no_goals_yet": "No goals yet",
        "no_habits_add": "No habits yet — add some in Habits page!",
        "no_goals_add": "No goals yet — add your first goal!",
        ...
        "select_goals_sub": "You can select more than one or skip",
        "ready": "Ready, {name}!",
        "ready_sub": "Your habits and goals are saved.\nOne small step each day — big results!",
        "back": "← Back",
        ...
        "amazing_keep_going": "You're doing amazing! Keep pushing forward on your journey to greatness.",
        "every_small_step": "Every small step counts. Mark a habit done today to start your streak.",
        "go_to_habits_check_off": "Go to Habits and check off what you did today",
        "add_task_or_timer": "Add a task or start a focus timer",
        "stats_fill_automatically": "Come back here — your stats will fill in automatically",
    ...
    "fa": {
        ...
        "delete_session_confirm": "آیا «{name}» حذف شود؟",
        "reset": "بازنشانی",
        ...
        "tap_habit_to_mark_done": "روی یک عادت بزن تا انجام‌شده علامت بخورد",
        "good_morning": "صبح بخیر",
        "good_afternoon": "بعدازظهر بخیر",
        "good_evening": "عصر بخیر",
        "go_to_habits_check_off": "به بخش عادت‌ها برو و کارهایی که امروز انجام دادی را علامت بزن",
        "add_task_or_timer": "یک تسک اضافه کن یا تایمر تمرکز را شروع کن",
        "stats_fill_automatically": "دوباره به اینجا برگرد — آمار پیشرفتت خودکار تکمیل می‌شود",
        "amazing_keep_going": "عالی پیش می‌روی! به مسیر رشدت ادامه بده.",
        "every_small_step": "هر قدم کوچک مهم است. امروز یک عادت را انجام بده تا زنجیره‌ات شروع شود.",
        "ms_choose_topic": "انتخاب موضوع",
        "ms_beginner_lessons": "یادگیری مباحث مقدماتی",
        "ms_practice_consistently": "تمرین مداوم",
        "ms_build_small_project": "ساخت پروژه کوچک",
        "ms_master_basics": "تسلط بر مبانی",
        # App
        ...
        "duration": "مدت زمان",
        # Dashboard
        "welcome_first_time": "Welcome! Your habits are ready — check your first ones to see your progress here.",
        ...
        # Empty states
        "no_habits_yet": "هنوز عادتی ندارید — در صفحه عادت‌ها اضافه کنید",
        "no_tasks_today": "امروز تسکی برای انجام نیست",
        "no_goals_yet": "هنوز هدفی ندارید",
        "no_habits_add": "هنوز عادتی ندارید — در صفحه عادت‌ها اضافه کنید!",
        "no_goals_add": "هنوز هدفی ندارید — اولین هدف خود را اضافه کنید!",
        ...
        "select_goals_sub": "می‌تونی بیشتر از یکی انتخاب کنی یا رد کنی",
        "ready": "آماده‌ای، {name}!",
        "ready_sub": "عادت‌ها و اهدافت ذخیره شدن.\nهر روز یه قدم کوچیک — نتایج بزرگ می‌سازه!",
        "back": "← برگشت",
        ...
        # Dashboard
        "welcome_first_time": "خوش اومدی! عادت‌هات آماده‌ان — اولین‌هاشون رو تیک بزن تا پیشرفتت اینجا دیده بشه.",
